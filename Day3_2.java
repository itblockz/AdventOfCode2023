...
public class Day3_2 {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> a = getNumberList2(map, symbols, numbers);
    ...
    static ArrayList<Point> getSymbolPoints(ArrayList<String> map) {
        ...
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                if (String.valueOf(map.get(i).charAt(j)).matches("\\*")) {
                    p.add(new Point(j, i));
                }
            }
        }
    ...
    static ArrayList<Integer> getNumberList2(ArrayList<String> map, ArrayList<Point> symbols, boolean[][] number) {
